...
//	#warning "Compiler optimizations disabled; functions from usart.h might not work as designed"
	...
	#define RX_BUFFER_SIZE 64 // Size of the ring buffers, must be power of 2
#endif

#ifndef TX_BUFFER_SIZE
	#define TX_BUFFER_SIZE 64 // Size of the ring buffers, must be power of 2
#endif
 ...
 ************************************************************************************/
		...
		void uart0_putstr(const char *string); // send string from the memory buffer // stops when NULL byte is hit (NULL byte is not included into transmission)
